...
const LudoGame = () => {
    ...
    const { players, rollDice, currentTurn, movePiece } = useGame();

    const renderPathTiles = (count: number, highlighted: boolean = false, bgColor?: string) => {
    ...
    const handleRollDice = () => {
        ...
        if (currentPlayer && !currentPlayer.pieces.some((pos) => pos > 0) && currentPlayer.noOfPieces > 0) {
